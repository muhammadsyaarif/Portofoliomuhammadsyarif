      ...
      <div className="mx-6 sm:mx-[100px] h-auto mt-4 sm:mt-[64px]">
        ...
        <div className="flex flex-col mt-8 sm:mt-16">
          ...
          <p className="text-xl text-justify">
            Website Pemesanan Catering adalah aplikasi web yang dirancang untuk
            memudahkan pelanggan dalam memesan layanan catering secara online.
            Dibangun menggunakan CodeIgniter 3, sebuah framework PHP yang ringan
            dan kuat, aplikasi ini menyediakan fitur lengkap untuk mengelola
            pesanan catering, mulai dari pembuatan pesanan, pembaruan, hingga
            penghapusan data pesanan.
          </p>
        </div>
